...
var SettingsTab = /** @class */ (function (_super) {
    ...
    SettingsTab.prototype.display = function () {
        ...
        containerEl.empty();
        containerEl.createEl('h2', { text: '增强编辑 0.2.9' });
        ...
        new obsidian.Setting(containerEl)
            .setName(' List of Features, 【增强功能　　快捷键】　说明......')
        var div = containerEl.createEl('p', {
            cls: 'recent-files-donation',
        });
        var donateText = document.createDocumentFragment();
        donateText.appendText('[Convert MD/Wiki Link syntax]　Add or remove [[link]] symbols at both ends of the selected text. Also support the conversion of multi-line or multi-sentence titles and texts separated by Newline character \n or Comma to MD/Wiki Link, and vice versa.【转换内链语法　　Alt+Z】　在选文两端添加或去除 [[链接]] 符号')
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('[Convert heading level]　Specify or cancel the current line of text as an N-level heading. 　——支持转换由换行符\n 或顿号、分隔的多行或多句标题文本为内链语法。')
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('[Convert highlighting grammar]　Add or remove==highlight==symbol at both ends of the selected text.  【转换标题语法　　Ctrl+ 1-6】　指定或取消当前行文本为N级标题');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('【Convert inline code　　Alt+ _ 】　Add or remove the symbol of _ inline code ` at both ends of the selected text.  【转换高亮语法　　Alt+G】　在选文两端添加或去除 ==高亮== 符号');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('[Convert code block] 　Add or remove the symbol of `code block` at both ends of the selected text.  【转换行内代码　　Alt+`】　在选文两端添加或去除 `行内代码` 符号');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('[Convert superscript] 　Add or remove the<sup>superscript</sup>syntax at both ends of the selected text.  【转换代码块　　Ctrl+Shift+M】　在选文两端添加或去除 ```代码块```符号');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('【Conversion subscript】　Add or remove the <sub>subscript</sub> syntax at both ends of the selected text.  【转换上标】　在选文两端添加或去除 <sup>上标</sup> 语法');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('【Conversion subscript】　Add or remove the <sub>subscript</sub> syntax at both ends of the selected text.  【转换下标】　在选文两端添加或去除 <sub>下标</sub> 语法');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('【Selected texts】　Add or remove 【】symbols at both ends of the selected texts.  【选文】　在选文两端添加或去除 【】符号');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('(Selected text) 　Add or remove the () symbol at both ends of the selected text.  （选文）　在选文两端添加或去除 （）符号');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('「Selected text」 　Add or remove the「 」 symbol at both ends of the selected text「选文」　在选文两端添加或去除 「」符号');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('《Selected text》 　Add or remove the《》 symbol at both ends of the selected text.  《选文》　在选文两端添加或去除 《》符号');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('[English to Chinese punctuation]　 Convert English punctuation in notes to Chinese punctuation, such as,.?!" etc.  【英转中文标点　　Ctrl+Shift+Alt+Z】　将笔记中的英文标点转换为中文标点，如,.?!"等');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('[Transfer English punctuation] 　 Convert Chinese punctuation in notes to English punctuation, such as. ? ! " etc.  【中转英文标点　　Ctrl+Shift+Alt+Y】　将笔记中的中文标点转换为英文标点，如，。？！“等');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('[ Path conversion]　 convertc:\\windowsand[](file:///c:\/windows)path syntax to each other.  【转换路径语法　　Shift+Alt+F】　将 c:\\windows 与 [](file:///c:\/windows) 路径语法相互转换');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('[Simplified to Traditional] 　 Convert simplified Chinese characters to traditional Chinese characters.  【简体转为繁体】　将笔记中的简体汉字转换为繁体汉字');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('[Traditional to Simplified] 　 Convert the traditional Chinese characters to simplified Chinese characters.  【繁体转为简体】　将笔记中的繁体汉字转换为简体汉字');
        donateText.appendChild(document.createElement('br'));
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('[Paste MD form]　 directly paste the copied Office form into MarkDown syntax form【粘贴MD表格　　Ctrl+Alt+V】.  　将复制的Office表格直接粘贴为MarkDown语法表格');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('[Fix wrong syntax]　Fix the wrong MD syntax in the notes, such as 1. List,[] ()link, [[]]() backlinks, etc..  【修复错误语法　　Ctrl+Shift+J】　修复笔记中的错误MD语法，如1。列表、【】（）链接、[[]]()回链等');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('[Fix unexpected line breaks]　Fix unexpected line break (delete line breaks at the end that are not punctuation such as sentence, question, exclamation mark).  【修复意外断行　　Ctrl+Alt+D】　修复笔记中的意外断行（删除结尾不是句、问、叹号等标点的换行符）');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('【Search the current text】　Search the selected content in the current document on the search panel..  【搜索当前文本】　通过搜索面板在当前文档中搜索划选内容。');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('[Get time information]　Get the time information in the current line, and control the video in the linked note to jump and play.  【获取时间信息　　Ctrl+Shift+T】　获取当前行中的时间信息，并控制链接笔记中的视频进行跳转播放');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('[Get labeled text] 　 get title, highlight, comment and paragraph prefix (#label, comment, reflection, remark) and other text content【获取标注文本　　Ctrl+Shift+B】　获取标题、高亮、注释及段落前缀（#标注、批注、反思、备注）等文本内容');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('【Get text without syntax】　Get the selected text after removing markdown syntax characters【获取无语法文本　　Ctrl+Alt+C】　获取去除markdown语法字符后的选文');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('【Get relative path】　Get the relative path of the current note in the library directory..  【获取相对路径】　获取当前笔记在库目录内的相对路径。');
        donateText.appendChild(document.createElement('br'));
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('【Batch insert blank lines】　Insert blank lines in the middle of the selected text line or the full text.  【批量插入空行　　Ctrl+Shift+L】　在划选的文本行或全文中间批量插入空白行');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('【Batch removal of blank lines】　Batch removal of blank lines in selected text or full text.  【批量去除空行　　Ctrl+Alt+L】　批量去除划选文本或全文中的空白行');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('【Add space at the end】　Add two spaces at the end of each text line to have a line break effect in preview mode.  【末尾追加空格　　Ctrl+Shift+K】　在每个文本行的末尾追加两个空格，以在预览模式时具有换行效果');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('[Remove trailing spaces]　Remove the space characters at the end of each text line in batches.  【去除末尾空格　　Ctrl+Alt+K】　批量去除每个文本行末尾的空格字符');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('【Add Chinese-English Space】　Add spaces in batches between Chinese characters and letters in the text, such as china China..  【添加中英间隔】　在正文的汉字与字母之间批量添加空格，如 china 中国。');
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('[Remove all spaces] 　Remove all full and half-width spaces in the text【去除所有空格】　去除正文中所有的全、半角空格');
        donateText.appendChild(document.createElement('br'));
        donateText.appendChild(document.createElement('br'));
        donateText.appendText('Welcome to the plugin page. Let us work together to enhance the ZH-Enhanced-Editing plugin! https://github.com/shaggyfeng/Obsidian-ZH-Enhanced-editing.  欢迎向蚕子(QQ:312815311) 提出操作需求和建议，我们为增强编辑功能来共同努力！');
